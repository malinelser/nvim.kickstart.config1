...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        python = { "isort", "black" }, -- also added in lspconfig. run :ConformInfo to know what auto formatters exists for the buffer //Malin
        --
  ...
  require 'kickstart.plugins.mini-nvim', -- thought all the plugins in the plugins folder ran automatically but apperantly not //Malin
